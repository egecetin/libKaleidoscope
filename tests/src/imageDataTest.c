...
START_TEST(ImageDataTest_Landscape)
{
...
START_TEST(ImageDataTest_Portrait)
{
	ImageData *imgPtr = NULL;
	int width = 768, height = 1024, nComponents = 3;
...
Suite *imageDataTestSuite(void)
{
	...
	tcase_add_test(tc_core, ImageDataTest_Portrait);
	tcase_add_test(tc_core, ImageDataTest_Landscape);
