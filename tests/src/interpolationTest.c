...
START_TEST(InterpolationTest)
{
	...
	char testDataInPath[] = "tests/data/interpolation_1024x768_InputData.bin";
	char testDataExpectedPath[] = "tests/data/interpolation_1024x768_ExpectedData.bin";

	// Init
	inPtr = (TransformationInfo *)malloc(width * height * sizeof(TransformationInfo));
	outPtr = (TransformationInfo *)malloc(width * height * sizeof(TransformationInfo));
